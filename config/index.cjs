...
const USER_CONFIG = {
  ...
  USERS: [
    {
      ...
      useTemplateId: '89hnJbDYqSVUTMIiVFmfQZbpWW5j-eGgH7JtWir7jyE',
      ...
      festivals: [
        ...
        {
          type: '生日', name: '宝贝', year: '1991', date: '05-14',
        },
        {
  ...
  CALLBACK_TEMPLATE_ID: '	89hnJbDYqSVUTMIiVFmfQZbpWW5j-eGgH7JtWir7jyE',
